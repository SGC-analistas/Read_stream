...
DEFAULT_VAL = {"server":"http://10.100.100.232:8091","network":None,
...
def read_args():
    ...
    parser.add_argument(prefix+"server",prefix*2+"server",
                        type=str,
                        default=DEFAULT_VAL["server"],
                        help="ejemplo: http://10.100.100.232:8091",
                        metavar='')
...
def read_st(server,net,sta,loc,cha,start,end,
...
if __name__ == "__main__":
    try:
        args = read_args()
        read_st(args.server,args.network,args.station,args.location,
